...
export default function HugeContent(){
    ...
    useEffect(() => {
        ...
        //Sans la fonction de nettoyage ci dessous (return de l'effect
        // mon listener continue d'exister meme en cas d'unmount du composant
        return () => {
            console.log("Nettoyage de l'event  listener");
